...
public class linkedMinHeapTree<T extends Comparable<T>> {
...
//	}
	...
	public boolean equals(Object other){
		...
		if(other.getClass() != getClass())
			return false;
		linkedMinHeapTree<T> ocasted = null;
		try {
			ocasted = (linkedMinHeapTree<T>)other;
	...
	public void add(T element) {
		...
		if(root==null) {
			...
			if(root.left==null) {
				...
				root.add(element,Integer.toBinaryString(size()+1),root);
				count++;
				siftup();
				//siftup();
				return;
	...
	public void siftup() {
		...
		//System.out.println("this is current data: "+temp.data+"prev data is:"+temp.prev.data);
		if(temp==root) {
			return;
		}
		else {
	...
	public T removeLast() {
		...
		T temp=root.removeLast(Integer.toBinaryString(size()));
...
//						"coming from"+current.data);
	...
	public class Node<Type extends Comparable<Type>>{
		...
		public Type removeLast(String binaryString) {
...
//			return retVal;
		...
		public void add(Type element, String size,Node<Type> root){
